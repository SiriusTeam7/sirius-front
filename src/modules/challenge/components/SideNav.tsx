import {
  ...
  const SideNav = () => {
    return (
      <div>
        <div className="hidden sm:flex flex-col bg-primary h-screen w-18 items-start px-4 py-6 space-y-6 text-white">
          <div className="flex items-center justify-center w-full">
            <img src={PlatziLogo} alt="Logo" className="h-6 w-6" />
          </div>
